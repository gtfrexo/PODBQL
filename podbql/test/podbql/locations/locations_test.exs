defmodule Podbql.LocationsTest do
  use Podbql.DataCase

  alias Podbql.Locations

  describe "locations" do
    alias Podbql.Locations.Location

    @valid_attrs %{address: "some address", addressFull: "some addressFull", city: "some city", country: "some country", lat: 120.5, lon: 120.5, state: "some state", zip: "some zip"}
    @update_attrs %{address: "some updated address", addressFull: "some updated addressFull", city: "some updated city", country: "some updated country", lat: 456.7, lon: 456.7, state: "some updated state", zip: "some updated zip"}
    @invalid_attrs %{address: nil, addressFull: nil, city: nil, country: nil, lat: nil, lon: nil, state: nil, zip: nil}
    ...
    test "create_location/1 with valid data creates a location" do
      ...
      assert location.addressFull == "some addressFull"
    ...
    test "update_location/2 with valid data updates the location" do
      ...
      assert location.addressFull == "some updated addressFull"
