defmodule PodbqlWeb.ChatControllerTest do
  use PodbqlWeb.ConnCase

  alias Podbql.Chats
  alias Podbql.Chats.Chat

  @create_attrs %{chatId: "7488a646-e31f-11e4-aace-600308960662", isBlocked: true}
  ...
  describe "create chat" do
    test "renders chat when data is valid", %{conn: conn} do
      ...
      assert json_response(conn, 200)["data"] == %{
        "id" => id,
        "chatId" => "7488a646-e31f-11e4-aace-600308960662",
        "isBlocked" => true}
    end
  ...
  describe "update chat" do
    ...
    test "renders chat when data is valid", %{conn: conn, chat: %Chat{id: id} = chat} do
      ...
      assert json_response(conn, 200)["data"] == %{
        "id" => id,
        "chatId" => "7488a646-e31f-11e4-aace-600308960668",
        "isBlocked" => false}
    end
