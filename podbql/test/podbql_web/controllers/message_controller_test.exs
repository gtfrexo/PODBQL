defmodule PodbqlWeb.MessageControllerTest do
  use PodbqlWeb.ConnCase

  alias Podbql.Messages
  alias Podbql.Messages.Message

  @create_attrs %{content: "some content", messageId: "7488a646-e31f-11e4-aace-600308960662", readAt: "2010-04-17 14:00:00.000000Z", wasRead: true}
  ...
  describe "create message" do
    test "renders message when data is valid", %{conn: conn} do
      ...
      assert json_response(conn, 200)["data"] == %{
        ...
        "messageId" => "7488a646-e31f-11e4-aace-600308960662",
        "readAt" => "2010-04-17 14:00:00.000000Z",
        "wasRead" => true}
    end
  ...
  describe "update message" do
    ...
    test "renders message when data is valid", %{conn: conn, message: %Message{id: id} = message} do
      ...
      assert json_response(conn, 200)["data"] == %{
        ...
        "messageId" => "7488a646-e31f-11e4-aace-600308960668",
        "readAt" => "2011-05-18 15:01:01.000000Z",
        "wasRead" => false}
    end
