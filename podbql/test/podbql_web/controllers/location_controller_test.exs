defmodule PodbqlWeb.LocationControllerTest do
  use PodbqlWeb.ConnCase

  alias Podbql.Locations
  alias Podbql.Locations.Location

  @create_attrs %{address: "some address", addressFull: "some addressFull", city: "some city", country: "some country", lat: 120.5, lon: 120.5, state: "some state", zip: "some zip"}
  ...
  describe "update location" do
    ...
    test "renders location when data is valid", %{conn: conn, location: %Location{id: id} = location} do
      ...
      assert json_response(conn, 200)["data"] == %{
        ...
        "addressFull" => "some updated addressFull",
